...
public class Initializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Park park6 = parkRepo.save(new Park("Lower Olentangy Urban Arboretum", "Clintonville", "https://lowerolentangyurbanarboretum.org", "", "lower-olentangy", category1, category3));
